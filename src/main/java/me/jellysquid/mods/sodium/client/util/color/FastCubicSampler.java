...
public class FastCubicSampler {
    ...
    private static final int VOLUME = DIAMETER * DIAMETER * DIAMETER;
        ...
        for (int x = 0; x < DIAMETER; ++x) {
            ...
            for (int y = 0; y < DIAMETER; ++y) {
                ...
                for (int z = 0; z < DIAMETER; ++z) {
                    int blockZ = (intZ - 2) + z;
                    values[baseIndex++] = colorFetcher.fetch(blockX, blockY, blockZ);
                }
            }
        }
        ...
        for (int x = 0; x < DIAMETER; ++x) {
            ...
            for (int y = 0; y < DIAMETER; ++y) {
                ...
                for (int z = 0; z < DIAMETER; ++z) {
                    ...
                    totalFactor += factor;
                    Vec3d color = transformer.apply(Vec3d.unpackRgb(values[baseIndex++]));
